...
def main():
    ...
    if OVERWRITE:
        ...
        # 2026-08-06 v1
        #   position:
        #     x: -0.09342006968172523
        #     y: -0.7627121477706021
        #     z: 0.7505495275480107
        #   orientation:
        #     x: 0.5310163135445399
        #     y: -0.48517639862850737
        #     z: -0.4665196300452916
        #     w: 0.514766910111598
        # insert_pose = np.array([
        #     -0.09342006968172523,
        #     -0.7627121477706021 - 0.03,
        #     0.7505495275480107,
        #     0.5310163135445399,
        #     -0.48517639862850737,
        #     -0.4665196300452916,
        ...
        # 2026-08-06 v2 (pre-insert pose, so a bit high)
        #   position: 
        #     x: -0.09565013749885604
        #     y: -0.7588316399316748
        #     z: 0.7778729374204962
        #   orientation: 
        #     x: 0.5262649340398102
        #     y: -0.4889885629729057
        #     z: -0.4608641591066554
        #     w: 0.5210946471925069

        # 2026-08-06 v3: pre-insert pose
        #   position:
        #     x: -0.09789244140165793
        #     y: -0.7788556290032278
        #     z: 0.7785261779707919
        #   orientation:
        #     x: 0.516452183451675
        #     y: -0.4970572406586461
        #     z: -0.49697010870259845
        #     w: 0.48911343548602043
        insert_pose = np.array([
            -0.09789244140165793,
            -0.7788556290032278,
            0.7785261779707919 - 0.0375,
            0.5,
            -0.5,
            -0.5,
            0.5,
